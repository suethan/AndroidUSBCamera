...
public class VideoEncoderFromBuffer {
    ...
    private static final String DEBUG_FILE_NAME_BASE = Environment.getExternalStorageDirectory().getPath() + "/Movies/h264";
    ...
    private static final int BIT_RATE = CameraHandler.PREVIEW_HEIGHT * CameraHandler.PREVIEW_WIDTH * 3 * 8 * FRAME_RATE / COMPRESS_RATIO; // bit rate CameraWrapper.
    private int mWidth;
    private int mHeight;
