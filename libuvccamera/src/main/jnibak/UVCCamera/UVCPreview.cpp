...
void UVCPreview::callbackPixelFormatChanged() {
	...
	switch (mPixelFormat) {
	  ...
	  case PIXEL_FORMAT_NV21:
		...
		callbackPixelBytes = (sz * 3) / 2;
		break;
	  case PIXEL_FORMAT_YUV20SP_HALF:
		LOGI("PIXEL_FORMAT_YUV20SP_HALF:");
		mFrameCallbackFunc = uvc_yuyv2yuv420SPHalf;
		callbackPixelBytes = (sz * 3) / 4;
		break;
	  case PIXEL_FORMAT_NV21_HALF:
		LOGI("PIXEL_FORMAT_NV21_HALF:");
		mFrameCallbackFunc = uvc_yuyv2iyuv420SPHalf;
		callbackPixelBytes = (sz * 3) / 4;
		break;
	}
}
